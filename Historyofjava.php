...
<div class="row">
  ...
  <div class="col-sm-8"">
    <div class="jumbotron" style="text-align: center; background-color: white;color: #34495e;width: 100%" >
      ...
      <h3 style="color: green">History Of Java</h3>
  ...
  <a  class="btn btn-info pre" href="installationofjava.php">Previous</a>
  <a class="btn btn-info next" href="setpath.php">Next</a>
  </div>
  <br clear="all">
