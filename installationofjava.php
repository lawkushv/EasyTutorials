...
<div class="row">
  ...
  <li class="list-item"><a href="installtionofjava.php">Installation of JDK</a></li><br>
  ...
  <div class="col-sm-8"">
    <div class="jumbotron" style="text-align: center; background-color: white;color: #34495e;width: 100%" >
      ...
      <h3 style="color: green">Installation of JDK</h3>
    <p style="text-align: left;">
      ...
      <br>
      <b>1. Download JDK file </b>
      <br>
        First step is to download the lastest  JDK version from oracle site.
    </p>
    <iframe width="560" height="315" src="https://www.youtube.com/embed/LlLRjFptXAY" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
  </div>
  <a  class="btn btn-info pre" href="mainpage.php">Previous</a>
  <a class="btn btn-info next" href="Historyofjava.php">Next</a>
  </div>
  <br clear="all">
